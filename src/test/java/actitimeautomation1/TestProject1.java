...
{   public static WebDriver driver;
    ...
    {   Object[][] obj=new Object[][]
            {   {"CyberCheck16","Connection16","project regarding the netowork connecntion of the particular area16"}
            };
        return obj;
    }
    ...
    @Test(priority = 3, dependsOnMethods = "checkCustomerProject",dataProvider = "getCustProjectData")
    public void deleteingtheProject(Object customerName, Object proName,Object discriptionArea) throws InterruptedException {
        projectPage.deleteCustomer(customerName.toString());
    }
